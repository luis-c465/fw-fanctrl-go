...
This strategies gets appended to the [default config](https://github.com/luis-c465/fw-fanctrl/blob/main/resources/config.json).

If you find any issue feel free to open an [Bug report | packaging/nix](https://github.com/luis-c465/fw-fanctrl/issues)!
